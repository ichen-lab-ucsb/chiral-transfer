#Program to intake data from .csv and fit it to kinetic model
#Additional code to generate all Figures for the manuscript is included
#Program should run as long as the correct directory for the source data files are provided.

# Change this directory to that of the "Aminoacylation chirality data.csv" file
chiralityDataDirectory <- "/Users/josh/Desktop/Aminoacylation chirality data.csv"

# Change this directory to that of the "Genetic distances.csv" file
distancesDirectory <- "/Users/josh/Desktop/Genetic distances.csv"
...
chiralityImportData <- read.csv(chiralityDataDirectory)
distances <- read.csv(distancesDirectory)
